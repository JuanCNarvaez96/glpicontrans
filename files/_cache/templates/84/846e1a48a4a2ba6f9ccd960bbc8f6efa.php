...
class __TwigTemplate_977b4777745a4ce7404eaaa54cb9bf1f extends Template
{
    private $source;
    private $macros = [];
...
";
   ...
   ";
            // line 157
            if ((twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "isField", [0 => "is_dynamic"], "method", false, false, false, 157) && ((twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "getType", [], "method", false, false, false, 157) == "NetworkEquipment") || (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "getType", [], "method", false, false, false, 157) == "Printer")))) {
                // line 158
                echo "      <div class=\"card-body row\">
         <div class=\"mb-3 col-12 col-sm-6\">
            <label class=\"form-label\" >";
   ...
   ";
            // line 166
            if ((((($__internal_compile_7 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 166)) && is_array($__internal_compile_7) || $__internal_compile_7 instanceof ArrayAccess ? ($__internal_compile_7["id"] ?? null) : null) > 0) && twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "isField", [0 => "is_dynamic"], "method", false, false, false, 166))) {
                // line 167
                echo "      ";
...
";
    ...
    {
        return array (  292 => 169,  286 => 167,  284 => 166,  281 => 165,  274 => 161,  270 => 160,  266 => 158,  264 => 157,  261 => 156,  245 => 143,  241 => 142,  234 => 138,  215 => 122,  211 => 121,  204 => 117,  190 => 106,  185 => 104,  181 => 103,  173 => 98,  168 => 96,  164 => 95,  152 => 86,  148 => 85,  141 => 81,  137 => 80,  130 => 76,  126 => 75,  119 => 71,  115 => 70,  107 => 65,  103 => 64,  98 => 62,  94 => 60,  91 => 59,  89 => 58,  86 => 57,  80 => 54,  74 => 52,  67 => 48,  60 => 45,  57 => 44,  55 => 43,  50 => 41,  42 => 35,  40 => 34,  37 => 33,);
    }

    public function getSourceContext()
    {
        return new Source("", "components/form/inventory_info.html.twig", "C:\\xampp\\htdocs\\coltrans\\glpiColtrans\\templates\\components\\form\\inventory_info.html.twig");
    }
}
