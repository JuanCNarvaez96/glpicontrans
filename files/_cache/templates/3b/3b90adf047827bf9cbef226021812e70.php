...
class __TwigTemplate_924edff3f90847730019a57b74822177 extends Template
{
    private $source;
    private $macros = [];
...
($context["right_field_options"] ?? null)], 228, $context, $this->getSourceContext());
        ...
        echo "
               ...
               ";
        // line 235
        echo twig_call_macro($macros["fields"], "macro_textareaField", ["content", (($__internal_compile_11 =         // line 237
($context["params"] ?? null)) && is_array($__internal_compile_11) || $__internal_compile_11 instanceof ArrayAccess ? ($__internal_compile_11["content"] ?? null) : null), __("Description"), twig_array_merge(        // line 239
($context["right_field_options"] ?? null), ["enable_richtext" => true, "enable_fileupload" => ((twig_get_attribute($this->env, $this->source,         // line 241
($context["itiltemplate"] ?? null), "isHiddenField", [0 => "_documents_id"], "method", false, false, false, 241)) ? (false) : (true))])], 235, $context, $this->getSourceContext());
        // line 243
        echo "
            </div>
        </div>
